#!/usr/bin/python3
from ctypes import c_ubyte, c_uint16, c_uint32, c_int32, c_uint64, c_int64, sizeof, cast, Structure, Union, ARRAY, POINTER
import _ctypes
...
class Elf32_Shdr(Structure, NiceHexFieldRepr):
...
class Elf64_Shdr(Structure, NiceHexFieldRepr):
...
class Elf32_Ehdr(Structure, NiceHexFieldRepr):
...
class Elf64_Ehdr(Structure, NiceHexFieldRepr):
    _fields_ = [("e_ident", c_ubyte*elfmacros.EI_NIDENT),
                ("e_type", elf64_half),
...
class Elf32_Phdr(Structure, NiceHexFieldRepr):
...
class Elf64_Phdr(Structure, NiceHexFieldRepr):
...
class Elf64_Rel(Structure, NiceHexFieldRepr):
    _fields_ = [("r_offset", elf64_addr),
                ("r_info", elf64_xword)]


class Elf32_Rela(Structure, NiceHexFieldRepr):
    _fields_ = [("r_offset", elf32_addr),
                ("r_info", elf32_word),
                ("r_addend", elf32_sword)]


class Elf64_Rela(Structure, NiceHexFieldRepr):
    _fields_ = [("r_offset", elf64_addr),
                ("r_info", elf64_xword),
                ("r_addend", elf64_sxword)]


class Elf32_Dyn(Structure, NiceHexFieldRepr):
...
class Elf64_Dyn(Structure, NiceHexFieldRepr):
...
class Elf32_Move(Structure, NiceHexFieldRepr):
...
class Elf64_Move(Structure, NiceHexFieldRepr):
...
class Elf32_Lib(Structure, NiceHexFieldRepr):
...
class Elf64_Lib(Structure, NiceHexFieldRepr):
...
class Elf32_Verdef(Structure, NiceHexFieldRepr):
...
class Elf64_Verdef(Structure, NiceHexFieldRepr):
...
class Elf32_Verdaux(Structure, NiceHexFieldRepr):
    _fields_ = [("vda_name", elf32_word),
                ("vda_next", elf32_word)]


class Elf64_Verdaux(Structure, NiceHexFieldRepr):
    _fields_ = [("vda_name", elf64_word),
                ("vda_next", elf64_word)]


class Elf32_Verneed(Structure, NiceHexFieldRepr):
...
class Elf64_Verneed(Structure, NiceHexFieldRepr):
...
class Elf32_Vernaux(Structure, NiceHexFieldRepr):
...
class Elf64_Vernaux(Structure, NiceHexFieldRepr):
...
class Elf32_aux_t(Structure, NiceHexFieldRepr):
...
class Elf64_aux_t(Structure, NiceHexFieldRepr):
...
class Elf32_Nhdr(Structure, NiceHexFieldRepr):
    _fields_ = [("n_namesz", elf32_word),
                ("n_descsz", elf32_word),
                ("n_type", elf32_word)]


class Elf64_Nhdr(Structure, NiceHexFieldRepr):
